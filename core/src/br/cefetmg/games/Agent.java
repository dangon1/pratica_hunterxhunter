...
import br.cefetmg.games.pathfinding.HeuristicaManhattan;
...
public class Agent {
    ...
    public void setGoal(int x, int y) {
        ...
        // ESCOLHER ENTRE HeuristicaManhattan() ou HeuristicaDistanciaEuclidiana()
        pathFinder.searchConnectionPath(startNode, targetNode, new HeuristicaManhattan(), path); 
